...
Ghostbill helps users upload a bank file and understand which recurring outgoing charges look forgotten versus expected.
...
**Must NOT:** guess arbitrary nested JSON structures. Unsupported shapes → `PARSE_ERROR`.
